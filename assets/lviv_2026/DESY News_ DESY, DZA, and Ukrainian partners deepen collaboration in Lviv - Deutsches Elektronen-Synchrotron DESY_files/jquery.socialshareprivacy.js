...
(function ($) {
    ...
    var baseurl = $("script[src$='jquery.socialshareprivacy.js']").attr("src");
        ...
        var defaults = {
            'services' : {
                'facebook' : {
                    ...
                    'sharer'            : {
                        'status'        : 'off',
                        'dummy_img'     : baseurl+'/socialshareprivacy/images/dummy_facebook_share_de.png',
                        'img'           : baseurl+'/socialshareprivacy/images/dummy_facebook_share_active_de.png'
                    }
                }, 
                'twitter' : {
                    'status'            : 'on', 
            ...
            'cookie_expires'    : '365',
            'css_path'          : baseurl+'/socialshareprivacy/socialshareprivacy.css',
            'uri'               : getURI,
            'language'          : 'de',
            'lang_path'         : baseurl+'/socialshareprivacy/lang/',
            'skin'              : 'light',
